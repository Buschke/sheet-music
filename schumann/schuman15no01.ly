...
%
			...
			<e-2 g-4>\( <e a>
			<ds-3 fs-4> <d-2 g-5>\)
			e-2^"ritard."\( fs g8. a16  b8.^\fermata
			c16 d4^"a tempo"\)\( g fs8.^\markup { \fontsize #-3 \number "4-5" } e16 d4\)
			b-2\( g' fs8.^\markup { \fontsize #-3 \number "4-5" } e16-4 d4-3\)
...
bassvoices =  {
	\relative c' {
		\context Voice = "bassvoice" {
			\stemDown
			\fingerD
			<g-3>8 r8 <cs,-5> r d r <fs-4> r <g-3> r cs, r d r <fs-4> r
			<g-3> r b,  r  c r <e-4> r <d-5> r d r g, r g' r
%
			\phrasingSlurDown
			<e-2>4 \( a, <d-3>8. <c-4>16  <b-5>4 \)
			<c-2> \( fs, <b-3>8. <a-4>16 <g-5>4 \)
			<c-3>4 \( <c-5>4 <b-3>8. <a-4>16 <g-5>4 \)
			<g'-3>8 r8 cs, r d r  <fs-4> r <g-3> r cs, r d r <fs-4> r
