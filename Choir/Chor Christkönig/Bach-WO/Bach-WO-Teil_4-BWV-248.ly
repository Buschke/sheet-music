...
scoreATenorVoice = \scoreDATenorVoice

scoreAVerse = \scoreDAVerse

\bookpart {
  \header {
    title = "Fallt mit Danken, fallt mit Loben"
    subsubtitle = "36. Chor, F-Dur"
  }
  \score {
    \new Staff \with {
...
scoreBTenorVoice = \scoreDBTenorVoice

scoreBVerse = \scoreDBVerse

\bookpart {
  \header {
    title = "Jesu richte mein Beginnen"
    subsubtitle = "42. Choral, F-Dur"
  }
  \score {
    \new Staff \with {
      instrumentName = "Tenor"
