\version "2.22.0"
\header {
    title = \markup \center-column { \larger "La Traviata" "Atto Primo" " " }
...
upper = \relative c'' {
    ...
    a8-5 r \ottava #1 cis-2 fis e r a4->-5 |
    gis8 e \acciaccatura {gis} fis4-> e8 cis \acciaccatura {e} d4 \ottava #0 | % 1.2 - 8
    cis8-.-2 a-.-1 b-.-3 e,-.-1 a4-3 r |
    e2.\trill cis'8 b |
    a8 r \ottava #1 cis fis e r a4-> |
    gis8 e \acciaccatura {gis} fis4-> e8 cis \acciaccatura {e} d4 \ottava #0 | % 1.3 - 12
    ...
    a8-.-4 eis16-2\( gis-4\) fis8-.-3 cis16-2\( e\) d8-. ais16\( cis\) b8-. e-. \ottava #0 |
    ...
    cis8 \ottava #1 cis'16\( d\) dis8-. e-. eis-. fis-. g-. gis-. |
    a8-. eis16\( gis\) fis8-. cis16\( e\) d8-. ais16\( cis\) b8-. e-. |
    cis8-. cis16\( d\) dis8-. e-. eis-. fis-. g-. gis-. |  % 3.4 - 55
    a8-. eis16\( gis\) fis8-. cis16\( e\) d8-. ais16\( cis\) b8-. e-. \ottava #0 |
    ...
    a8 \ottava #0 r a8-3( \override Fingering.avoid-slur = #'inside gis-2 a gis a-1 \revert Fingering.avoid-slur bes-2) |
    \bar "||"
    \key c \major
    ...
    e8-. c-. \acciaccatura {e} d4-> c8-. a-. \acciaccatura {c} bes4-> |
    a8-. c-. g-. c-. f,4 r8. f16 |
    f2.\trill \ottava #1 d'8-. c-. | % 8.4 - 156
    bes8-. r d-. g-. f-. r bes4-> |
    a8-. f-. \acciaccatura {a} g4-> f8-. d-. \acciaccatura {f} ees4-> |
    <d, d'>4->\ff a'8 fis <d d'>4-> a'8 fis \ottava #0 | % 8.5 - 159
    d4(\p bes8 g) d'4( bes8 g) |
    \ottava #1 <d' d'>4->\ff( a'8 fis) <d d'>4->( a'8 fis) \ottava #0 |
    d4(\p bes8 g) d'4( bes8 g) |
    ...
    << {\ottava #1 d'16-5 cis-4 b-3 a-2 d-5 cis b a d cis b a d cis b a} \\ {<a fis d>8\ff r fis4-1 fis fis} >> |
    ...
    << {\stemDown <f a c f>4 \ottava #0 } \\ {s4} >> r4\fermata r2 | % fin
    \bar "|."
}
...
lower = \relative c {
    ...
    << {\once\override TextScript.extra-offset = #'(0.5 . 0)<g'a>1^\markup{\finger "1   1"}} \\ {a,2-5\sustainOn a,} >> |
    << {s2 a''4 bes->} \\ {d,,2\sustainOff fis4 g} >> |
    << {<g'a>1 }\\ {\once\override Staff.SustainPedal.extra-offset = #'(0 . 2) a,2-5\sustainOn \once\override Staff.SustainPedal.extra-offset = #'(2.5 . 2) a,)\sustainOff} >> | % 9.1 - 168
    << {s2 a''4 bes->} \\ {d,,2( fis4 \once\override Script.avoid-slur = #'inside g->} >> |
    << {<g' a>1} \\ {\once\override Staff.SustainPedal.extra-offset = #'(0 . 4) a,2\sustainOn a,2} >> |
    << {s2 a''4 bes->} \\ {\once\override Staff.SustainPedal.extra-offset = #'(-1.5 . 2) d,,2\sustainOff <fis fis'>4 \once\override Script.avoid-slur = #'inside <g g'>->} >> |
