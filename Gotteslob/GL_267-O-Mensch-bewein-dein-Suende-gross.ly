...
\header {
  ...
  subtitle = "C.F."
  subsubtitle = "Choräle, vierstimmig gesetzt"
  instrument = "Chor / Orgel"
  composer = "M: Matthäus Greiter 1525"
  arranger = "Satz: Sven Buschke"
  poet = "T: nach Sebald Heyden um 1530"
  meter = ""
  piece = ""
  opus = "GL 267 ö"
  copyright = ""
...
scoreAMelody = \relative c'' {
  ...
  % Music follows here.
  \repeat volta 2 {
    c,2 c4 d e c e f g2\breathe
    g f4 e d c e f g2\breathe
    a g4 f e c d2 c r
  }
...
%   \new FretBoards \scoreAChordNamesLeadSheet
  \new Staff \with {
