...
\header {
    ...
    composer =	\cCompositeur
		...
		poet = \markup \box { \pad-around #1 {"Flauto 2"}}	%% placé en haut à gauche
		instrumentHeader = \markup {"Flauto 2"}
}	%% fin header
