...
\header {
    ...
    composer =	\cCompositeur
		...
		poet = \markup \box { \pad-around #1 {"Fagotto 1"}}	%% placé en haut à gauche
		instrumentHeader = \markup {"Fagotto 1"}
}	%% fin header
