...
%%
\header{
    title = \markup {\center-align { \medium "Ich ruf ' zu dir, Herr Jesu Christ"} }
%     subtitle = \markup {\small\medium "Je crie vers Toi, Seigneur J̩sus." \medium\small "Unto Thee I cry, Lord Jesus."}
    piece = ""
    instrument = ""
    ...
    enteredby = "Sven Buschke"
    maintainer = "Sven Buschke"
