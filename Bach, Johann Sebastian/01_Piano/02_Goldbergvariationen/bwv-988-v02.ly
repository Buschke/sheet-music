...
soprano = \relative c''' {
    ...
    \repeat volta 2 { %begin repeated section
        ...
        a2\rest
        g4 c4^~\prallmordent
        c8 b16 a16 b16 a16 g16 fs16
        g4^~ g16 f16 e16 d16
  
        %6-10
        e4^~ e16 d16 c16 b16
        a4^~ a16 c16 b16 a16
        b16 g'16 fs16 a16 g16 fs16 e16 d16
        c'8^( b8) b4\rest
        r2

        %11-15
        b,16^( ds16 e16 g16) b4^~
        b16 a16 g16 b16 a16 g16 fs16 e16 
        d4^~ d16 c16 b16 a16
        b4^~ b16 a16 g16 fs16
        e4^~ e16 g16 fs16 e16
}        
    ...
    \repeat volta 2 { %begin repeated section
        \stemUp a4 a'4^~
        a16 g16 fs16 a16 g16 fs16 e16 ds16
        e4 a8\rest fs8
        ds8 b8 d4\rest
        ...
        e4^~ e16 d16 c16 b16
        c4^~ c16 b16 a16 g16
        fs4^~ fs16 a16 g16 fs16
        g4 f'4\rest
        e,4 a4^~ 

        %26-30       
        a16 g16 fs16 a16 g16 fs16 e16 d16
        c4 c'4^~
        c16 b16 a16 c16 b16 a16 g16 fs16
        b8[ g8] b8[ d8]
        g4 c4^~
...
alto = \relative c'' {
        ...
        g16 fs16 e16 g16 fs4
        g8 e8\rest e4\rest
        g16^( a16 b16 d16) e4^~
        e16 d16 cs16 e16 d16 cs16 b16 a16
        
        %11-15
        g4 b8\rest g'8
        e8 cs8 b4\rest
        e,16\rest a16[ g16 b16] a8 fs8_~
        fs16 e16 d16 fs16 e8 d8_~
        d16 cs16 b16 d16 cs4
}
        %16-20
        \alternative { { d8 e8\rest e4\rest } { d4 e4\rest } }     
        \repeat volta 2 { %begin repeated section
        \stemDown c16\rest fs'16[ e16 g16] fs16 e16 d16 cs16
        d4 b8\rest b8
        g8 e8 a4_~
        a16 g16 fs16 a16 g16 fs16 e16 ds!16

        %21-25    
        e16 b'16 a16 c16 b8 g8_~
        g16 fs16 e16 g16 fs8 e8_~
        e16 ds16 cs16 e16 ds4
        e4 b'4_~
        b16 a16 g16 b16 a16 g16 fs16 e16
        ...
        g4_~
        g16 fs16 e16 g16 fs16 e16 d16 c16
        d4 c4\rest
        d'4 f4_~
        f16 e16 d16 f16 e16 g16 fs16 g16
...
bass = \relative c' {
    \repeat volta 2 { %begin repeated section
        ...
        \pageBreak
        \repeat volta 2 { %begin repeated section
        \stemDown d''8[ cs8 d8 a8]
        b8[ a8 b8 g8]
        c16 c,16 b16 d16 \stemUp c16 b16 a16 c16
        \stemDown b16 b'16 a16 c16 b16 a16 g16 fs16

        %21-25
        g8[ fs8 g8 e8] 
        a8[ g8 a8 fs8]
        b8[ as8 b8 b,8]
        \stemUp e,16 e'16 ds16 fs16 e16 d16 c16 b16
        \stemDown c8[ b8 c8 a'8]    

        %26-30
        b,8[ a8 b8 g'8]
        a,8[ g8 a8 g'8]
        fs16 d16 c16 e16 \stemUp d16 c16 b16 a16
        \stemDown g16 g'16 f16 a16 g16 f16 e16 d16
        c16 c'16 b16 d16 c16 b16 a16 g16   

        %31-32
        fs16 g16 fs16 a16 \stemUp b,8 d8
    } %end repeated section
        \alternative { { \stemDown g,8[ g'16 fs16] g16 a16 b16 c16 } { \stemDown g8 d8 \stemUp g,4 } }
