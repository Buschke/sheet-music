...
soprano = \relative c'' {
    ...
    \repeat volta 2 { %begin repeated section
        ...
        %6-10
        e8 \appoggiatura d16 c8 \appoggiatura b16 \stemUp a4. \stemDown fs'8\turn
        \stemDown g32[( fs16.) a32( g16.)] fs32[( e16.) d32( c16.)] \once \override Slur.direction = #UP \appoggiatura c8 a'8. c,16
        \stemUp b32[( g16.) fs8] \appoggiatura fs8 g2\prallmordent
        b4 b4( cs8.\prallmordent) d16
        d16 cs16 b16 a16_~ \stemDown a2 \stemUp

        %11-15
        <g b e g>4\arpeggio \stemDown g'4.\downprall fs16 g16
        \override NoteColumn.ignore-collision = ##t
        g8 \appoggiatura fs16 e8 \once \override Stem.length-fraction = #(magstep -6) cs4.\downprall e8
        a16( g16 fs16 e16) d8 \stemUp a4_~ a32 b32 c16
        b16( a16 g16 fs16) e8 \appoggiatura d'16 cs4_~ cs32 d32 e16
        d16^( cs16 b16 a16) g'8 b,4 cs8

        %16-20
        \appoggiatura cs16 d8^~[ d32 e32 d32 cs32] \appoggiatura cs8 d2
    } %end of repeated section
    \repeat volta 2 { %begin repeated section
        a4\prallmordent a4_~\downprall a16[ a32( b32 c32 d32 e16)]
        \appoggiatura e16 d8 \appoggiatura c16 b8 \appoggiatura a8 g4. g'8
        \appoggiatura fs16 e8. fs32 ds32 \appoggiatura ds8 e4.\prallmordent a32 b32 a32 g32
        a8. fs16 \appoggiatura e8 ds4. b8

        %21-25
        \stemDown g'8. \prallup fs16 \appoggiatura fs8 e4^~ e16[ b16 c32( b32 a32 b32)]
        g'32[( e16.) fs32( ds16.)] \appoggiatura ds8 e4^~ \stemUp e16 g,16 fs16 e16
        fs8. e'16 \appoggiatura e16 ds8 a'8 \prallup g8 fs8
        \appoggiatura fs16 e8. fs32 ds32 \appoggiatura ds8 e2
        ...
        c16 d16 c16 b16 c16 a16 fs16 a16 c16 e16 d16 c16
        b16 c16 b16 a16 b16 g16 d16 g16 b16 g16 c16 d16
        e16 f16 e16 d16 e16 c16 g16 c16 e16 c16 fs16 g16

        %31-32
        a16 c,16 b16 a16 b16 c16 d16 g,16 b16 a16 g16 fs16
        g4^~ g16 d16 g16 fs16 \appoggiatura fs8 g4\fermata
...
bassOne = \relative c' {
    ...
    c2_~ c8 d8
    e8 c8 d2
    g,4. d'8[ e8.\prallmordent fs16]
    g2._~
    g4 fs8\prallprall e8 fs8 b8
...
bassTwo = \relative c' {
    ...
    f'4\rest a,2
    f'4\rest g,2
    f'4\rest \stemUp fs,2
    f'4\rest d,2

    %6-10
    s4 e4. s8
    f'8\rest c8^~ c8[ b16 a16] g16 fs16 e16 fs16
    g8 a8 b2
    s4 b2
    ...
    %11-15
    f,8\rest b,8 e4. d8
    cs8 d8 \staffUpper e2 \staffLower
    f4\rest a,2
    ...
    %16-20
    g4 fs2
    \staffLower a8\rest e8 \once \override Stem.length-fraction = #(magstep -2) fs2^\prallmordent
    f8\rest c8 d2
    f8\rest e8 g4 fs8^\prallprall e8
    ds8 e8 \staffUpper fs2

    %21-25
    \staffLower f8\rest a,8 g8^\prallprall fs8 g4
    f'8\rest a,8 g8^\prallprall fs8 g8 b8
    \staffUpper fs'4. c'8 b8 a8_~
    a4 g2
    \staffLower s4 e,2
...
bassThree = \relative c' {
    ...
    %26-30
    a8 fs8 \once \override Slur.direction = #DOWN \appoggiatura e16 d8[ e16 fs16] g16[ fs16 g8]^~
